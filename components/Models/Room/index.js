...
const Room = ({ scale, position, rotation }) => {
        ...
        <>
            ...
            >
                <mesh
                    ...
                    castShadow
                    receiveShadow
                    position={light ? [94, 104, -134.78] : [94, 103.5, -134.78]}
                    rotation={[0.44, 0, -0.13]}
                    onClick={() => setLight(!light)}
                />
                <group name="light desk" position={[72.04, 132.16, -143]}>
                    <pointLight
                        name="light desk1"
                        castShadow
                        intensity={light ? '1' : '0'}
                    ...
                    <mesh
                        ...
                        castShadow
                        receiveShadow
                        position={[19.31, -30.03, 0.45]}
                    />
                </group>
                <group name="picture" position={[34.52, 119.06, -149.5]} rotation={[0, -Math.PI / 9, 0]}>
                    <mesh
                        name="Rectangle"
                ...
                <group name="notebook" position={[-33, 113.07, -126.89]}>
                    ...
                    <mesh
                        ...
                        material={materials['Boolean2 Material']}
                        castShadow
                        receiveShadow
